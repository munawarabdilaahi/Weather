              ...
              <tr key={day.day} className="border-b border-border last:border-b-0 hover:bg-secondary/30 transition">
                ...
                <td className="py-3 px-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground">{t(weatherConditionKey(day.condition))}</span>
                  </div>
                </td>
                <td className="py-3 px-4">
                  <div className="flex items-center gap-4">
                    <div className="h-2 w-24 md:w-32 rounded-full bg-secondary/70">
                      <div
                        className="h-full bg-gradient-to-r from-primary to-accent rounded-full"
                        style={{ width: `${(day.high / maxHigh) * 100}%` }}
                      />
                    </div>
